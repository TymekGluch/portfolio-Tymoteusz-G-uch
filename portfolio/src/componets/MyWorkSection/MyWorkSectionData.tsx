...
const MyWorkSectionData = [
  ...
  {
    TITLE: 'MZTS app',
    TEXT: 'Official website powered by Next.js and TypeScript for the Masovian Sports Dance Association. Project created from the beginning open source and pro-bono',
    IMAGE:
